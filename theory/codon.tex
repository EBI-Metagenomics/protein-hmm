...
\Cref{fig:core-model} shows a possible HMM architecture for aligning sequences of amino-acids,
...
The codon emitted at node $\state{M}_j$ in \Cref{fig:codon-hmm-tree} can go through $m\in\{0, 1, 2, 3,
...
\begin{figure}[htbp]
  ...
  \caption{
      ...
      $p(M=m)<p(M=m+1)$, as per \Cref{fig:indel-dist}.
  }\label{fig:dist}
\end{figure}
