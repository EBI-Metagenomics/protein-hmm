...
$p(X_t=x_1x_2x_3 \gv Q_t = q_t)$ and parameter $\eps$ based on the outlined method. We will omit the
...
We have
\begin{equation*}
  p(Z=z_1 \gv X=x_1x_2x_3) = \sum_{i=1,2,3}\ind_{z_1}(x_i) (\eps^2/3)(1-\eps)^2
\end{equation*}
